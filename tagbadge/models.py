...
BADGE_TYPE_CHOICES = [("GOLD", "Gold"), ("SILVER", "Silver"), ("BRONZE", "Bronze")]
...
class TagBadge(models.Model):
    ...
    bade_position = models.CharField(
        max_length=30, choices=BADGE_POSITION_CHOICES, default=""
    )
    url = models.URLField(blank=True, null=True)
    questionIf_TagOf_Q = models.ForeignKey(
        Question, on_delete=models.CASCADE, blank=True, null=True
    )
    answerIf_TagOf_A = models.ForeignKey(
