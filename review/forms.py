...
class FlagQuestionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {"actions_Flag_Q": forms.RadioSelect()}
...
class ReviewFlagCommentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {"c_flagReviewActions": forms.RadioSelect()}
...
class LowQualityReviewForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {"reviewActions": forms.RadioSelect()}
...
class FlagPostForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {"flagReviewActions": forms.RadioSelect()}
...
class CloseForm_Q(forms.ModelForm):
    class Meta:
        ...
        widgets = {"why_closing": forms.RadioSelect()}
...
class AnswerReviewForm(forms.ModelForm):
    class Meta:
        ...
        fields = ["actions"]
        widgets = {"actions": forms.RadioSelect()}
...
class QuestionReviewForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {"questionActions": forms.RadioSelect()}
...
class LateAnswerReviewForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {"L_AnswerActions": forms.RadioSelect()}
...
class VoteToReOpenForm(forms.ModelForm):
    class Meta:
        ...
        fields = ["why_opening"]
        widgets = {"why_opening": forms.RadioSelect()}
